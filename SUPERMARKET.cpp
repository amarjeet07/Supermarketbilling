...
void Shopping:: menu()
{
	...
	switch(choice){
		case 1:
		{
			...
			if(email=="amarjeet898763@gmail.com" && password=="amar1625")
			{
				administrator();	
			}
			else{
...
void Shopping::administrator()
{
	...
	int choice;
	cout<<"\n\n\n\t\t\t\t Administrator menu\n";
	cout<<"\t\t\t\t|__1) Add the product__|\n";
	cout<<"\t\t\t\t|                      |\n";
	cout<<"\t\t\t\t|__2) Modify the product_|\n";
	cout<<"\t\t\t\t|                           |\n";
	cout<<"\t\t\t\t|__3) Delete the product_|\n";
	cout<<"\t\t\t\t|                           |\n";
	cout<<"\t\t\t\t|__4) Back to main menu__|\n";
	cout<<"\t\t\t\t|                           |\n";
...
void Shopping::receipt()
{
	...
	cout<<"\n\n\t\t\t\t__________________XXXXXXX_________________\n";
	cout<<"\n\t\t\t\t Total Amount : "<<total<<"\n\n";
}
